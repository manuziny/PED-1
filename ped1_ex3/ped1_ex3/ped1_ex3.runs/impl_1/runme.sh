...
HD_PWD='D:/UnB/FGA/Manu_PED1/ped1_ex3/ped1_ex3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log conv_bcd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source conv_bcd.tcl -notrace
