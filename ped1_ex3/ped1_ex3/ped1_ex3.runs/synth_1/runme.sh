...
HD_PWD='D:/UnB/FGA/Manu_PED1/ped1_ex3/ped1_ex3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conv_bcd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conv_bcd.tcl
